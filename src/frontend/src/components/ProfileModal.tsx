        ...
        <div className="space-y-6 py-4">
          {!isAuthenticated ? (
            <div className="text-center py-8 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground px-4">
                  Log in with Internet Identity to save your progress and level
                  up!
                </p>
              </div>
              ...
              <div className="pt-4">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-b from-sky-400 via-sky-500 to-sky-700" />
                  ...
                  <div className="absolute inset-0 rounded-xl bg-sky-900/50 translate-y-1 -z-10" />
                </button>
              </div>
            </div>
          ) : isLoading ? (
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 rounded-xl p-6 border-2 border-purple-400 shadow-2xl">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-purple-200 font-medium uppercase tracking-wide">
                          Prestige Level
                        </p>
                ...
                {Number(userProgress.level) < 100 && (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-amber-700 text-right">
                      ...
                      % to Level {Number(userProgress.level) + 1}
                    </p>
                  </div>
                )}
              ...
              {/* Join Date */}
              {userProfile?.joinedAt && userProfile.joinedAt !== BigInt(0) && (
