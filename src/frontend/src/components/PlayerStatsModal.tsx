...
import { X, Trophy, TrendingUp, Loader2, User, Calendar, Crown } from 'lucide-react';
...
const PlayerStatsModal: React.FC<PlayerStatsModalProps> = ({ isOpen, onClose, playerPrincipal }) => {
  const { data: playerStats, isLoading, error } = useGetPlayerStats(playerPrincipal);
            ...
            {isLoading ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-3">
                  ...
                  <p className="text-indigo-700 text-sm">Loading player stats...</p>
                </div>
              </div>
            ) : error ? (
              <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                ...
                <div>
                  <p className="text-xl font-semibold text-indigo-900">Unable to load player stats</p>
                  <p className="text-sm text-indigo-700 mt-1">Please try again later</p>
                </div>
              </div>
            ) : !playerStats ? (
              <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
                ...
                <div>
                  <p className="text-xl font-semibold text-indigo-900">No stats available</p>
                  <p className="text-sm text-indigo-700 mt-1">This player hasn't played yet</p>
                </div>
              </div>
            ) : (
              <>
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-5 border-2 border-indigo-300">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-sm font-semibold text-indigo-700 uppercase tracking-wide">Principal ID</h3>
                  </div>
                ...
                {hasPrestige && (
                  <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 rounded-xl p-5 border-2 border-purple-400 shadow-xl">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-sm font-semibold text-purple-200 uppercase tracking-wide">Prestige Level</h3>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-5 border-2 border-purple-300">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-sm font-semibold text-purple-700 uppercase tracking-wide">Level</h3>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border-2 border-blue-300">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-sm font-semibold text-blue-700 uppercase tracking-wide">Total XP</h3>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-5 border-2 border-amber-300">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-sm font-semibold text-amber-700 uppercase tracking-wide">Highest Score</h3>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl p-5 border-2 border-cyan-300">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-sm font-semibold text-cyan-700 uppercase tracking-wide">Clouds</h3>
                    </div>
                ...
                {playerStats.joinedAt && playerStats.joinedAt !== BigInt(0) && (
                  <div className="bg-gradient-to-br from-violet-50 to-violet-100 rounded-xl p-5 border-2 border-violet-300">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-sm font-semibold text-violet-700 uppercase tracking-wide">Joined</h3>
