...
export const XP_THRESHOLDS: number[] = [
  0, 2000, 4500, 7500, 11000, 15000, 19500, 24500, 30000, 36000, 42500, 49500,
  57000, 65000, 73500, 82500, 92000, 102000, 112500, 123500, 135000, 147000,
  159500, 172500, 186000, 200000, 214500, 229500, 245000, 261000, 277500,
  294500, 312000, 330000, 348500, 367500, 387000, 407000, 427500, 448500,
  470000, 492000, 514500, 537500, 561000, 585000, 609500, 634500, 660000,
  686000, 712500, 739500, 767000, 795000, 823500, 852500, 882000, 912000,
  942500, 973500, 1005000, 1037000, 1069500, 1102500, 1136000, 1170000, 1204500,
  1239500, 1275000, 1311000, 1347500, 1384500, 1422000, 1460000, 1498500,
  1537500, 1577000, 1617000, 1657500, 1698500, 1740000, 1782000, 1824500,
  1867500, 1911000, 1955000, 2000000, 2200000, 2400000, 2600000, 2800000,
  3000000, 3200000, 3400000, 3600000, 3800000, 4000000,
];
...
export function getXpForCurrentPrestige(currentPrestige: number): number {
  ...
  if (thresholdIndex < 0 || thresholdIndex >= PRESTIGE_THRESHOLDS.length)
    return 0;
 ...
 */
export function getCurrentPrestigeXp(
  totalXp: number,
 ...
 */
export function getXpNeededForNextPrestige(
  _totalXp: number,
  currentPrestige: number,
): number {
